...
const OrderData = (props) => {
    ...
    const debouncedValue = useDebounce(amountGive, 200)
    ...
    return (
        <div className={styles.orderData}>
            ...
            <div className={styles.orderData__currencyes}>
                ...
                <div className={styles.orderDataGive}>You Pay</div>
                ...
                <div className={styles.orderDataGiveContainer}>
                ...
                <div className={styles.orderDataGiveContainer}>
                    ...
                    <ul className={styles.networksList}>
                        <div className={styles.containerPriceOneCrypto}>
                            {`комиссия: ${selectedYouGive}`} //TODO Написать и вставить функцию расчёта коммисии 
                        </div>
                    </ul>
                </div>
