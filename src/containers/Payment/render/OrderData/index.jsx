...
const OrderData = (props) => {
    ...
    useEffect(() => {
        axios.get(`https://usaapi.indacoin.io/Currencies/rates?baseCurSymbol=${selectedYouGive}&quoteCurSymbol=${selectedYouGet}`)
              .then(function (response) {
                setOnePrice(response.data.toFixed(6));
              })
    }, [])
    ...
    return (
        <div className={styles.orderData}>
            <div className={styles.orderData__currencyes}>
                ...
                <span style={{ display: "flex", alignItems: "center" }}>See calculation below:</span>
                </div>
                ...
                {/* <div style={{ display: "flex" }}>
                    ...
                    <ul className={styles.networksListOne}>
                        7.42 USD
                    </ul>
                </div> */}
                ...
                <div style={{ display: "flex" }}>
                    ...
                    <ul className={styles.networksListTwo}>
                        {/* {priceOneCrypto} */}
                        1 {selectedYouGive} = {onePrice} {selectedYouGet}
                    </ul>
                </div>
            ...
            <div className={styles.orderData__buttonBlock}>
                ...
                <Button type={'button'} onClick={() => createRequest(false)} loading={loading} disabled={false} className={'button'} title={'Buy Now'}
                />
            </div>
