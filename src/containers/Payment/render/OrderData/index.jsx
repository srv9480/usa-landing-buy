    ...
    return (
        <div className={styles.orderData}>
            ...
            <div className={styles.orderData__currencyes}>
                ...
                <div className={styles.orderDataGive}></div>
                ...
                <div style={{display: "flex", textAlign: 'center', alignItems: "center", maxHeight: "30px", marginTop: "20px", marginBottom: "20px"}}>
                   ...
                   <span> See calculation below:</span>
                ...
                <span className={styles.orderData__currencyes__give}></span>
                <YouGet
